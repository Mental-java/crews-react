...
import {
    callUserReportWriteAPI
} from "../../apis/ReportAPICalls";

function UserReportModal({ setReportModal, reportTarget, reportTargetName}) {
    ...
    const onClickCrewReportHandler = () =>{
        ...
        dispatch(callUserReportWriteAPI({
            form: form
        }));
            ...
            <div className={ReportModalCSS.modalContainer}>
                <div className={ReportModalCSS.upDiv}>
                    ...
                    <div className={ReportModalCSS.crewName}>
                        <h5>신고 대상 유저 : {reportTargetName}</h5>
                    </div>
